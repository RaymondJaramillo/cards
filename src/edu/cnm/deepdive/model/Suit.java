...
/**
 * Encapsulates the suits of standard cards. The enum includes {@link #symbol()} and {@link #color()} methods, to return the immutable unicode symbol and {@link Color} enum instance of any suit.
 */
public enum Suit {
  ...
  /**
   * Returns unicode playing card symbol for this code
   *
